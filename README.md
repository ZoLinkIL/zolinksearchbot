...
- `חפש לי נייקי` — חיפוש טקסטואלי לפי מותג. חוזרת הודעה מעוצבת (⭐️ מותג, ✅ פרטים, 🔥 מחיר, 🔗 קישור מוסתר) + פוטר קבוע עם הסבר הזמנה, סרטון וקישור לבוט הראשי.
- שליחת תמונה — הבוט ישווה אותה לתמונות בקטלוג ויחזיר את אותה הודעה מעוצבת עבור ההתאמה הטובה ביותר.
